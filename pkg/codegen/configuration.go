...
type OutputOptions struct {
	...
	UserTemplates map[string]string     `yaml:"user-templates,omitempty"`      // Override built-in templates with static user-provided strings.
	UserTemplateFiles map[string]string `yaml:"user-template-files,omitempty"` // Override built-in templates from user-provided file names.
